...
public class MyWindow extends JFrame implements ActionListener,MouseMotionListener,MouseListener{
	...
	public MyWindow() {
		...
		btn2.setIcon(new ImageIcon("D:\\画图程序\\橡皮擦.jpg"));
		btn3.setIcon(new ImageIcon("D:\\画图程序\\选择颜色.jpg"));
		btn4.setIcon(new ImageIcon("D:\\画图程序\\直线.jpg"));
		btn5.setIcon(new ImageIcon("D:\\画图程序\\矩形.jpg"));
		btn6.setIcon(new ImageIcon("D:\\画图程序\\圆.jpg"));
		btn7.setIcon(new ImageIcon("D:\\画图程序\\椭圆.jpg"));
		btn9.setIcon(new ImageIcon("D:\\画图程序\\多边形.jpg"));
		btn8.setIcon(new ImageIcon("D:\\画图程序\\圆角矩形.jpg"));
